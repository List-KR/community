...
NamuLink 유저스크립트는 애드블록 커뮤니티와 AdGuard에서 관리하는 유저스크립트입니다.

:::note

NamuLink 유저스크립트 유지보수자는 다음 애드블록들 중 하나와 함께 NamuLink 유저스크립트를 사용하시길 권장합니다:
 - AdGuard
 - uBlock Origin
...
https://cdn.jsdelivr.net/gh/List-KR/NamuLink@latest/NamuLink.user.js
...
<ReactPlayer controls width='100%' height='100%' url='https://user-images.githubusercontent.com/98787049/205464257-9113ca81-7f9e-4e85-b4d3-03d225d25e37.webm' />

</details>
<details>
<summary>Google Chrome에서 설치하는 방법 (동영상)</summary>

<ReactPlayer controls width='100%' height='100%' url='https://user-images.githubusercontent.com/98787049/205464253-322b5e07-a74e-4c98-b7b4-077ec21be5c2.webm' />
...
7. 나무위키가 열려진 탭으로 돌아가신 뒤 <kbd>F5</kbd>나 <kbd>Ctrl</kbd> + <kbd>R</kbd>를 누르거나 새로 고침 버튼을 눌러서 새로 고침하세요.
...
6. 나무위키가 열려진 탭으로 돌아가신 뒤 <kbd>F5</kbd>나 <kbd>Ctrl</kbd> + <kbd>R</kbd>를 누르거나 새로 고침 버튼을 눌러서 새로 고침하세요.
...
<ReactPlayer width='560px' height='315px' controls url='https://youtu.be/LeHT1lokQ7k' />
...
아래 GitHub Issue에서 신고해주세요:
 - https://github.com/List-KR/NamuLink/issues
