...
애드쉴드는 최근 인벤 웹 사이트를 브라우징할 때 느려지는 현상과 크게 관련이 있습니다.
...
### Windows용 AdGuard
<details><summary>설치하기 (풀버전)</summary>
