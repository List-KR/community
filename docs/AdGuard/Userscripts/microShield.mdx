...
- Windows용 AdGuard
  ...
  <ReactPlayer controls width='100%' height='100%' url='/video/microshield/AdGuard/Windows.mp4' />
...
- Android용 AdGuard
  ...
  <ReactPlayer controls width='100%' height='100%' url='/video/microshield/AdGuard/Android.mp4' />
 ...
 - quoid의 userscripts (iOS) [^2][^3]
  ...
  <ReactPlayer controls width='100%' height='100%' url='/video/microshield/iOSUserscripts.mp4' />
